...
export const RecipeCard = ({
  ...
  return (
      <div className="flex flex-col sm:h-[380px] h-[260px] w-[260px] mb-4 sm:mb-2 ml-2 sm:mr-1 mr-2  rounded-lg shadow-md shadow-slate-500
           cursor-pointer">
      <div
        id="img"
      ...
      <div id={recipeId} className="content p-4 pb-0 ">
      ...
      <div id="Author-section" className="flex flex-row">
        <Image
